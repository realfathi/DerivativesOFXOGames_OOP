...
//return number of moves to check then if it is 24 and determine the winner.
int TicTacToe5x5::num_moves() {
    return n_moves;
}
...
bool TicTacToe5x5::is_winner() {
    ...
    if (count_x>count_o) cout<<"X wins\n";
    else if(count_o>count_x) cout<<"O wins\n";
    return false;
...
bool TicTacToe5x5::is_draw() {
    if (count_x==count_o&&n_moves==24)cout<<"Draw!\n";
    return false;
}
